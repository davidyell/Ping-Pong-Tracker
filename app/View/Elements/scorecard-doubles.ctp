    ...
    <tbody>
        <tr>
            <td>
                ...
                <br>&amp;</br>
                <?php echo $match['MatchesPlayer'][2]['Player']['first_name']; ?>
                "<?php echo $match['MatchesPlayer'][2]['Player']['nickname']; ?>"
                <?php echo $match['MatchesPlayer'][2]['Player']['last_name']; ?>
            </td>
            <td rowspan="2">&nbsp;VS&nbsp;</td>
            <td>
                ...
                <br>&amp;</br>
                <?php echo $match['MatchesPlayer'][3]['Player']['first_name']; ?>
                "<?php echo $match['MatchesPlayer'][3]['Player']['nickname']; ?>"
                <?php echo $match['MatchesPlayer'][3]['Player']['last_name']; ?>
            </td>
        </tr>
        <tr class="scores">
            <td>
